...
// خلف زرّ «المزيد» (⋯) في الهيدر — فالوصول إليه في الاختبار يمرّ بفتحه أولاً،
// تماماً كما يمرّ به المستخدم. انظر MoreMenu.tsx.
const openMoreMenu = () => fireEvent.click(screen.getByRole('button', { name: 'المزيد' }))

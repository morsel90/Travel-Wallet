...
interface AuthGateProps {
   ...
   * نافذة دخول ثانية خلف تسجيل دخول ناجح: متاحٌ لمن لا يحتاجه، محجوبٌ عمّن
   * يحتاجه. (تلك النافذة حُذفت بالكامل لاحقاً — هذه الشاشة هي سطح الدخول
   * الوحيد الآن.) انظر hooks/usePasswordReset.ts وdocs/DECISIONS.md.
   */

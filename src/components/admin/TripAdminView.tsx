...
//
// حلّت محلّ السكربتات اليدوية: إنشاء الرحلة ورمزها، وتحرير المسار، وعرض قائمة
// الرحلات. وقد حُذف سكربتا `add-flights.mjs` و`list-trips.mjs` فعلياً في
// 2026-08-14 لأن هذه الشاشة أغنت عنهما تماماً (انظر «Scripts» في
// Design Decisions بـ CLAUDE.md). الباقي منها لم يبقَ لتكرار ما هنا، بل لما لا
// يستطيعه التطبيق أصلاً: `set-admin.mjs` (منح صلاحية المسؤول — لا يجوز أن
// توجد له واجهة)، و`create-trip.mjs` (احتياطي حين لا تكون manageTrip منشورة).
//
// ⚠️ فلا تُضِف سكربتاً يكرّر شاشةً هنا: السكربت يعمل بـ Admin SDK فيتجاوز
// firestore.rules بالكامل، ويفوته كل تحقّق تفرضه هذه الواجهة.
//

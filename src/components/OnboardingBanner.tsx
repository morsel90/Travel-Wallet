  ...
  return (
    <div className="bg-teal-50 border border-teal-200 rounded-2xl p-4 flex items-start gap-3">
      ...
      <div className="flex-1 text-xs sm:text-sm text-teal-900 space-y-1.5">
        <p>
          <span className="font-bold">المودَع</span> هو ما دفعه كل مسافر مقدّماً، و
          <span className="font-bold"> الرصيد</span> هو هذا المبلغ ناقص نصيبه من المصاريف المشتركة حتى الآن — ويصير سالباً إن تجاوز نصيبُه ما أودعه.
        </p>
        <p>

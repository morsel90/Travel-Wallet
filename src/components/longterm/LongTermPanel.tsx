    ...
    <section id="long-term-section" className="scroll-mt-24">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        {/* ⚠️ هذا العنوان ليس تزييناً. بطاقة المسافر في «أرصدة المسافرين» **لا
            ...
            ⚠️ والزرّ **داخل ملف المسافر لا على البطاقة نفسها**: البطاقة تفتح
            TravelerProfileModal عند الضغط (TravelerSection.tsx)، وهناك يظهر
            «تسوية وخروج من الرحلة». النصّ أدناه كان يقول «زرّ … في بطاقته»
            فيبحث القارئ عنه على البطاقة ولا يجده — فصار يذكر الضغطتين معاً

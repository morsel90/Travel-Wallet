      ...
      <div className="flex border-b border-slate-100 bg-slate-50 p-1.5 gap-2 rounded-xl mb-4">
        <button
          ...
          className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${
            activeTab === 'expenses' ? 'bg-teal-600 text-white shadow-xs' : 'text-slate-500 hover:bg-slate-100'
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${
            activeTab === 'travelers' ? 'bg-teal-600 text-white shadow-xs' : 'text-slate-500 hover:bg-slate-100'
          }`}
        >

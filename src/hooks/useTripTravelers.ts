// 🆕 قائمة مسافري رحلة بعينها — من travelersColByTrip. مستقلّة عن useTripData()/
// مخزن الرحلة (store/tripStore.ts) لأن TripDetailPanel يعمل على *أي* رحلة بمعرّفها، لا الرحلة

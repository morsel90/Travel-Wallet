 ...
 *
 * 🆕 **تصف الأثر ولا تسمّي الحالة.** الحالتان `completed` و`archived` تبقيان
 * مفصولتين تماماً في الكود وفي firestore.rules — الفرق بينهما حقيقي (الأولى
 * تقبل تسوية الأرصدة، الثانية لا تقبل شيئاً) ولا يجوز طمسه هناك. لكن اسم
 * الحالة ليس ما يحتاجه المستخدم؛ ما يحتاجه هو *ماذا يستطيع الآن*.
 *
 * وكلمة «مؤرشفة» تحديداً كانت تضلّل: المألوف عنها (أرشيف واتساب) أنها مكان
 * تخزين يُخرَج منه متى شئت، لا أن العمليات المالية أُقفلت نهائياً. فحلّ محلّها
 * وصفُ الحدّ نفسه.
 */

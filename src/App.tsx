    ...
    screen = (
      ...
      >
        <ErrorBoundary fallback={<AppErrorFallback />}>
          ...
          {/* 🆕 min-h-dvh بدل فئة «الشاشة الكاملة» القديمة (التي تولّد 100vh):
              وحدة vh على iOS Safari هي ارتفاع الشاشة *الكبير* — بعد اختفاء شريط
              العنوان — فكانت الصفحة أطول من المساحة المرئية دوماً بمقدار ذلك
              الشريط، وتهتزّ (rubber-band) حتى حين لا محتوى يُمرَّر أصلاً. dvh
              يتبع الارتفاع المرئي فعلياً. مدعوم من Safari 15.4 وChrome 108 —
              أدنى من أرضية المشروع (iOS 16.4) فلا يُسقط أي جهاز مدعوم.
              ⚠️ لا تكتب اسم الفئة القديمة حرفياً في أي تعليق: ماسح Tailwind v4
              نصّي لا يفهم التعليقات، فيولّد لها قاعدة CSS ميتة من جديد. */}

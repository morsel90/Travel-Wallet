...
/**
 * 🆕 الرحلة الطويلة: البطاقة **بنفس تسميتَي الرحلة القياسية حرفياً**
 * («المودع»/«المتبقي»)، وما يختلف هو مصدر رقم «المودع» وحده: cycleWallet
 * المشتقة في useAppCoordinator (رصيد أول الشهر + أي إيداع خلاله) بدل إجمالي
 * المودَع التراكمي. اختلافُ الحساب تعقيدٌ داخلي، وإظهاره في التسمية كان
 * يجعله تعقيداً ظاهراً — انظر تعليق TravelerSection.tsx.
 *
 * ⚠️ 2400 لا 900: محفظة الشهر **لا يمكن أن تقلّ عن المتبقي** (المتبقي =
 * المحفظة − نصيبه من مصاريف الشهر). كانت القصة تعرض مودَعاً 900 مع متبقٍّ
 * 2190 — حالة مستحيلة تُظهر شريط التقدّم ممتلئاً دوماً. لم تكن تُقرأ كخطأ
 * فقط لأن التسميتين المختلفتين كانتا تُوهمان بأنهما رقمان لا علاقة بينهما.
 */
export const شهر_رحلة_طويلة: Story = {
  args: { traveler: fx.balancePositive, cycleWallet: 2400 },
}

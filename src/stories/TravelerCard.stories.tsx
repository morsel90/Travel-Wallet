...
/**
 * 🆕 الرحلة الطويلة: بطاقة المسافر تعرض «ميزانية الدورة»/«متبقي الدورة» بدل
 * «المودع»/«المتبقي» — cycleWallet المشتقة في useAppCoordinator (الرصيد
 * المتبقي التراكمي + حصته من مصاريف الشهر الحقيقية). لاحظ أن رقم «متبقي
 * الدورة» يبقى مطابقاً لرقم «المتبقي» في القصة الأولى (نفس traveler) — الفرق
 * كله في محفظة الدورة (رقم مختلف هنا عمداً عن إجمالي المودَع التراكمي).
 */
export const دورة_رحلة_طويلة: Story = {
  args: { traveler: fx.balancePositive, cycleWallet: 900 },
}

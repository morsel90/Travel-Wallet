...
/**
 * رسالة طويلة — تفحص التفاف النص على شاشة ضيقة (Toast.tsx لا يحدّ عرضه بـ
 * max-width، فطول الرسالة هو الاختبار الحقيقي). انظر التعليق في Toast.tsx عن
 * العلّة التي كشفها توست طويل مشابه لهذا (تعارض transform التمركز مع الحركة).
 */
export const رسالة_طويلة: Story = {
  args: {
    message: {
      text: 'أُزيل من قائمة الرحلة، لكنه مسؤول — وصلاحيته عامة ولا تمرّ بعضوية الرحلة، فلن يفقد وصوله رغم الإزالة.',
      type: 'success',
    },
  },
}

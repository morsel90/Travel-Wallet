...
//
// ⚠️ **ولا يكتب فوق سطر قائم أبداً.** سطرٌ كتبته verifyTripPin يحمل joinedAt
// حقيقياً؛ الكتابة فوقه تستبدل معلومة صادقة بأخرى مجهولة — أي أن تشغيل السكربت
// مرتين كان سيُفسد ما أصلحه في المرة الأولى.

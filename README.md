...
- **المصادقة:** تسجيل دخول إلزامي عبر Google أو بريد/كلمة مرور — لا جلسات
  مجهولة ولا رمز رحلة (PIN)؛ المسؤول حساب Email/Password يُنشأ يدوياً في
...
[MIT](LICENSE) © 2026 Mohammed Alathim

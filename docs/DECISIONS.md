...
🐛 **وكان فيها افتراضٌ خاطئ اكتُشف في الإنتاج:** أن الدائن دائنٌ بإيداعه. لكنّه في هذا الدفتر يصير دائناً أيضاً بدفع مصاريف **من جيبه** (`paidBy`)، وحينها يتجاوز رصيده ما أودعه، فينزل «المودَع» تحت الصفر بعد الخصم. حدث ذلك مرة واحدة (Bh26: ‎-170.5). والسالب يخالف `isFiniteAmount` (`>= 0`) في القواعد، ويكسر مطابقة `replayDepositLogs` (التي تقصر عند الصفر). **الحلّ المؤقت حارس يرفض** بسبب مفهوم ولا يكتب شيئاً. تمثيل «استرداد ما دُفع من الجيب» قرار نموذج بيانات لم يُتّخذ بعد: إمّا السماح بمودَع سالب بمعنى «سحب من الصندوق» (يمسّ القواعد و`applyDepositMode` والتقارير)، أو قيدٌ ثالث لا هو إيداع ولا مصروف. والتسوية تختفي من القائمة لأن الرصيدَين صارا صحيحَين، لا لأن أحداً أشّر عليها — وهذا وحده ما يجعلها تبقى مختفية بعد إضافة مصاريف جديدة.

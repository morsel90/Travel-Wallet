...
**متى يُعاد فتح القرار:** حين يظهر سبب هجرة *فعلي* (فاتورة تتجاوز حداً، أو حاجة لاستعلامات علائقية لا يقدر عليها Firestore). حينها ابدأ من القواعد والدوال والبيانات، لا من واجهات العميل. وتأمين الخروج الأرخص هو البيانات: صيغة النسخة الاحتياطية (`restoreTrip`) يجب أن تبقى مستقلة عن أنواع Firestore.

...
**محاولة ثالثة مرفوضة أيضاً: أيقونة قلم مستقلة بجانب «حسابي».** أصلحت مشكلة الاختفاء (ثابتة بصرف النظر عن تقلّص الهيدر)، لكن صاحب الحساب رفضها من زاوية مختلفة: عنصر إضافي يزحم هيدراً مزدحماً أصلاً (شعار، اسم/إحصاءات، AccountMenu). **الحل النهائي: شعار التطبيق نفسه (أيقونة الرسم الدائري) يصبح الزرّ**، بشارة قلم صغيرة عليه (نفس نمط نقطة «غير متصل» الحمراء الموجودة أصلاً) — يعيد استخدام عنصر ثابت قائم بدل إضافة عنصر جديد، ويحلّ مشكلتي الاختفاء والازدحام معاً.

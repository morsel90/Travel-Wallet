...
**«رحلاتي» زرٌّ مستقلّ في الهيدر الآن** (أيقونة حقيبة بجانب الأفاتار): نقرة واحدة، نمط زرّ الرجوع من المحادثة إلى قائمة المحادثات. ولا يظهر إطلاقاً لمن له رحلة واحدة — لا شيء يُرجَع إليه. القاعدة التي تُصنّف: **هل هذا حساب أم مسار؟** المسار لا يسكن قائمة الحساب.

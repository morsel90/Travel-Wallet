...
⚠️ **وزوجٌ واحد لم يُحسم عمداً: «المتبقي» و«الرصيد».** كلاهما يصف نفس الرقم (`remaining`)، والأول في الترويسة والتقارير والطباعة وExcel والثاني في تعديل الرصيد وكشف الحساب. توحيدهما يمسّ أرقاماً مطبوعة ومصدَّرة تُقرأ خارج التطبيق، فهو قرار صاحب الحساب لا قرار تنظيف.

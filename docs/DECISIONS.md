...
**ولا تُكرَّر في القائمة أي نقطة دخول قائمة.** «تعديل الرحلة» يبقى أيضاً على اسم الرحلة في الهيدر لأنه المُشير الطبيعي إليها؛ أما التقارير/الإحصائيات/المسار/السلة فلا وجود لها في أي مكان آخر — نفس المبدأ الذي أزال «تصدير Excel» و«إدارة الرحلات» من مواضعهما المكرَّرة سابقاً. واختيارية كل بند في `MoreMenuActions` هي حارس صلاحيته: غياب الخاصية هو التعطيل، لا شرطٌ داخل `MoreMenu`.
